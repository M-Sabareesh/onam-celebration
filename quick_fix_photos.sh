...
# Quick fix script for treasure hunt photo issues
...
python manage.py debug_media --fix-permissions

# 5. Test the treasure hunt page
echo "🧪 Step 5: Testing treasure hunt functionality..."
python -c "
...
print('📍 Media Root:', getattr(settings, 'MEDIA_ROOT', 'Not set'))
