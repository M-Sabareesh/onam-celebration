"""
Base settings for onam_project.
"""
import os
...
THIRD_PARTY_APPS = [
    'rest_framework',
    'corsheaders',
    # 'bootstrap5',  # Temporarily disabled - install django-bootstrap5 first
    # 'phonenumber_field',  # Temporarily disabled
...
LOCAL_APPS = [
    'apps.core',
    # 'apps.accounts',  # Temporarily disabled due to signals import issue
    # 'apps.games',     # Temporarily disabled
    # 'apps.sms',       # Temporarily disabled
]
...
MIDDLEWARE = [
    ...
    # 'django_otp.middleware.OTPMiddleware',  # Temporarily disabled
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'apps.core.middleware.PlayerOnlineStatusMiddleware',  # Track player online status
]

ROOT_URLCONF = 'onam_project.urls'
...
WSGI_APPLICATION = 'onam_project.wsgi.application'
...
# Use default Django User model instead of custom one
# AUTH_USER_MODEL = 'accounts.User'  # Disabled for simplicity
...
MESSAGEBIRD_ORIGINATOR = env('MESSAGEBIRD_ORIGINATOR', default='OnamApp')
...
# OTP Settings
OTP_TOTP_ISSUER = 'Onam Celebration App'
OTP_LOGIN_URL = '/accounts/login/'

# Game Settings
TREASURE_HUNT_LEVELS = env('TREASURE_HUNT_LEVELS', default=5)
SMS_RATE_LIMIT_PER_HOUR = env('SMS_RATE_LIMIT_PER_HOUR', default=10)
OTP_EXPIRY_MINUTES = env('OTP_EXPIRY_MINUTES', default=5)
